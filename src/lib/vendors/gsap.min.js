...
!(function (t, e) {
  ...
  function Aa(t, e) {
    ...
    return (
      r &&
        r.smoothChildTiming &&
        t._ts &&
        ((t._start = ca(r._time - (0 < t._ts ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts))), za(t), r._dirty || ta(r, t)),
      t
    );
  }
  function Ba(t, e) {
    var r;
    if (
      ((e._time || (e._initted && !e._dur)) && ((r = ya(t.rawTime(), e)), (!e._dur || yt(0, e.totalDuration(), r) - e._tTime > j) && e.render(r, !0)),
    ...
    return (
      ...
      function (t, e, r) {
        ...
        if (!c) {
          ...
          for (c = y[d] = [], i = b ? Math.min(f, d) * w - 0.5 : g % f, n = b ? (d * x) / f - 0.5 : (g / f) | 0, l = U, u = h = 0; u < d; u++)
  ...
  function nb(t, e, r) {
    return (
      ((6 * (t = t < 0 ? t + 1 : 1 < t ? t - 1 : t) < 1 ? e + (r - e) * t * 6 : t < 0.5 ? r : 3 * t < 2 ? e + (r - e) * (2 / 3 - t) * 6 : e) * Ot + 0.5) | 0
    );
  }
  function ob(t, e, r) {
    var i,
    ...
    if (!c) {
      if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Mt[t])) c = Mt[t];
        ...
        if (
          (t.length < 6 &&
            (t = "#" + (i = t.charAt(1)) + i + (n = t.charAt(2)) + n + (a = t.charAt(3)) + a + (5 === t.length ? t.charAt(4) + t.charAt(4) : "")),
          9 === t.length)
        )
    ...
    return (
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                return this;
              if (((g = this._dur), (m = this._tDur), T && ((this._lock = 2), (_ = b ? g : -1e-4), this.render(_, !0)), (this._lock = 0), !this._ts && !u))
                return this;
              Eb(this, p);
            }
          }
            ...
            ((v === m && m >= this.totalDuration()) || (!v && _)) &&
              ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                ...
                e ||
                  (t < 0 && !_) ||
                  (!v && !_) ||
                  (xt(this, v === m ? "onComplete" : "onReverseComplete", !0), !this._prom || (v < m && 0 < this.timeScale()) || this._prom())));
        }
        return this;
      }),
      ...
      (e.getTweensOf = function getTweensOf(t, e) {
        for (var r, i = [], n = Tt(t), a = this._first, s = q(e); a; )
          a instanceof Vt
            ? da(a._targets, n) &&
              (s ? (!qt || (a._initted && a._ts)) && a.globalTime(0) <= e && a.globalTime(a.totalDuration()) > e : !e || a.isActive()) &&
              i.push(a)
  ...
  var qt,
    ...
    Vt = (function (A) {
      function Tween(e, r, i, n) {
        ...
        if (
          ((a._targets = P.length ? $(P) : O("GSAP target " + e + " not found. https://greensock.com", !Y.nullTargetWarn) || []),
          (a._ptLookup = []),
          (a._overwrite = T),
          w || b || v(m) || v(g))
        ) {
          ...
          if (p) {
            if (_ !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != t < 0)) {
              if (((i = _), (l = this.timeline), this._repeat)) {
                ...
                a !== o &&
                  ...
                  !this.vars.repeatRefresh || u || this._lock || ((this._lock = r = 1), (this.render(ca(s * a), !0).invalidate()._lock = 0)));
              }
              if (!this._initted) {
              ...
              (l && l.render(t < 0 ? t : !i && u ? -j : l._dur * h, e, r)) || (this._startAt && (this._zTime = t)),
                ...
                (_ !== this._tDur && _) ||
                  ...
                  e ||
                    (t < 0 && !d) ||
                    (!_ && !d) ||
                    (xt(this, _ === c ? "onComplete" : "onReverseComplete", !0), !this._prom || (_ < c && 0 < this.timeScale()) || this._prom()));
            }
          } else
            !(function _renderZeroDurationTween(t, e, r, i) {
              ...
              if (
                ...
                for (
                  s = t._zTime, t._zTime = e || (r ? j : 0), r = r || (e && !s), t.ratio = u, t._from && (u = 1 - u), t._time = 0, t._tTime = l, n = t._pt;
                  n;
  ...
  function sd(e) {
    ...
    return (
      ...
      !r || r.width || r.x || r.y ? r : { x: +rd(e, ["x", "cx", "x1"]) || 0, y: +rd(e, ["y", "cy", "y1"]) || 0, width: 0, height: 0 }
    );
  }
  function td(t) {
  ...
  function ud(t, e) {
    if (e) {
      ...
      e in Se && e !== Ye && (e = qe),
        r.removeProperty
          ? (("ms" !== e.substr(0, 2) && "webkit" !== e.substr(0, 6)) || (e = "-" + e), r.removeProperty(e.replace(Le, "-$1").toLowerCase()))
          : r.removeAttribute(e);
    }
  }
  ...
  function Bd(t) {
    var e = t.split(" "),
      ...
      i = e[1] || "50%";
    return (
      ("top" !== r && "bottom" !== r && "left" !== i && "right" !== i) || ((t = r), (r = i), (i = t)), (e[0] = Xe[r] || r), (e[1] = Xe[i] || i), e.join(" ")
    );
  }
  function Cd(t, e) {
  ...
  function Vd(t, e, r) {
    var i,
      ...
      f = r.style;
    for (n in (l.svg
      ? ((a = r.getAttribute("transform")), r.setAttribute("transform", ""), (f[qe] = e), (i = Je(r, 1)), ud(r, qe), r.setAttribute("transform", a))
  ...
  var se,
    ...
    Je = function _parseTransform(t, e) {
      ...
      return (
        ...
        (r.svg = !(!t.getCTM || !td(t))),
        (m = Id(t, r.svg)),
        r.svg && ((k = !r.uncache && !e && t.getAttribute("data-svg-origin")), Jd(t, k || B, !!k || r.originIsAbsolute, !1 !== r.smooth, m)),
        (p = r.xOrigin || 0),
        (_ = r.yOrigin || 0),
        m !== Ge &&
          ((b = m[0]),
          ...
          6 === m.length
            ...
            : ((E = m[6]),
              ...
              g &&
                ...
                (E = P)),
              (l = (g = Ee(-w, S)) * ze),
              g && ((v = Math.cos(-g)), (I = x * (y = Math.sin(-g)) + I * v), (b = k = b * v - A * y), (T = C = T * v - D * y), (w = P = w * v - S * y)),
              (u = (g = Ee(T, b)) * ze),
              ...
              (c = I ? 1 / (I < 0 ? -I : I) : 0)),
          r.svg && ((k = t.getAttribute("transform")), (r.forceCSS = t.setAttribute("transform", "") || !Gd(md(t, qe))), k && t.setAttribute("transform", k))),
        90 < Math.abs(f) &&
          Math.abs(f) < 270 &&
          (R ? ((s *= -1), (f += u <= 0 ? 180 : -180), (u += u <= 0 ? 180 : -180)) : ((o *= -1), (f += f <= 0 ? 180 : -180))),
        (r.x =
          i -
                ...
                if (
                  ...
                  if ("transformOrigin" === f) {
                    (s = Bd(s)),
                      g.svg
                        ? Jd(t, s, 0, v, 0, this)
                        : ((c = parseFloat(s.split(" ")[2]) || 0) !== g.zOrigin && vd(this, g, "zOrigin", g.zOrigin, c), vd(this, T, f, We(a), We(s)));
                    continue;
                  }
                  if ("svgOrigin" === f) {
                    Jd(t, s, 1, v, 0, this);
