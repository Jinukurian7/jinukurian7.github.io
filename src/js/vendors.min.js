...
!function (e, t) {
  ...
  function Ua(e) {
    var t,
      ...
      o = 0;
    if (g !== r || He) {
      for (I(); o < _.length; o += 4) (t = ke.matchMedia(_[o]).matches) !== _[o + 3] && ((_[o + 3] = t) ? n.push(o) : I(1, _[o]) || W(_[o + 2]) && _[o + 2]());
    ...
    pt = function _setState(e) {
      if (e) {
        var t,
          ...
          o = e.length,
          i = 0;
        for ((e.t._gsap || Me.core.getCache(e.t)).uncache = 1; i < o; i += 2) r = e[i + 1], t = e[i], r ? n[t] = r : n[t] && n.removeProperty(t.replace(j, "-$1").toLowerCase());
      }
    },
    dt = {
      left: 0,
  ...
  var G = (ScrollTrigger.prototype.init = function init(w, C) {
    if (this.progress = this.start = 0, this.vars && this.kill(1), Ze) {
      ...
      Te.media = Fe, fe *= 45, Te.scroller = ve, Te.scroll = P(ve, te), M = Te.scroll(), Te.vars = w, C = C || w.animation, "refreshPriority" in w && (Re = 1), l.tweenScroll = l.tweenScroll || {
        ...
        min: 0.1,
        max: 2
      }, p = Y(p) ? Ae(p.min, p.max) : Ae(p, p), y = Me.delayedCall(de.delay || o / 2 || 0.1, function () {
        ...
        if (!Ie && Te.enabled || t) if (se && e && Ye) Ca(ScrollTrigger, "scrollEnd", Va);else {
          ...
          for (var r, n, o, i, a, s, l, c, f, u = Ce(), p = Oe(), d = T(ve, te), g = 0, h = 0, v = w.end, m = w.endTrigger || ae, b = w.start || (0 !== w.start && ae ? se ? "0 0" : "0 100%" : 0), x = ae && Math.max(0, ct.indexOf(Te)) || 0, y = x; y--;) (s = ct[y]).end || s.refresh(0, 1) || (Ie = 1), !(l = s.pin) || l !== ae && l !== se || s.revert();
          for (_ = lb(b, ae, u, te, Te.scroll(), A, I, Te, p, we, be, d) || (se ? -0.001 : 0), W(v) && (v = v(Te)), V(v) && !v.indexOf("+=") && (~v.indexOf(" ") ? v = (V(b) ? b.split(" ")[0] : "") + v : (g = Ha(v.substr(2), u), v = V(b) ? b : _ + g, m = ae)), E = Math.max(_, lb(v || (m ? "100% 0" : d), m, u, te, Te.scroll() + g, B, L, Te, p, we, be, d)) || -0.001, z = E - _ || (_ -= 0.01) && 0.001, g = 0, y = x; y--;) (l = (s = ct[y]).pin) && s.start - s._pinPush < _ && (r = s.end - s.start, l === ae && (g += r), l === se && (h += r));
          if (_ += g, E += g, Te._pinPush = h, A && g && ((r = {})[te.a] = "+=" + g, Me.set([A, B], r)), se) r = ta(se), i = te === it, o = Te.scroll(), Z = parseFloat(U(te.a)) + h, !d && 1 < E && ((me ? Ee : ve).style["overflow-" + te.a] = "scroll"), fb(se, H, r), F = ib(se), n = at(se, !0), c = be && P(ve, i ? ot : it)(), le && ((q = [le + te.os2, z + h + nt]).t = H, (y = le === et ? xa(se, te) + z + h : 0) && q.push(te.d, y + nt), pt(q), be && Te.scroll(G)), be && ((a = {
            ...
            return o.t = e.t, o;
          }(R, a, ge)), C ? (f = C._initted, Ve(1), C.render(C.duration(), !0, !0), j = U(te.a) - Z + z + h, z !== j && D.splice(D.length - 2, 2), C.render(0, !0, !0), f || C.invalidate(), Ve(0)) : j = z;else if (ae && Te.scroll()) for (n = ae.parentNode; n && n !== Ee;) n._pinOffset && (_ -= n._pinOffset, E -= n._pinOffset), n = n.parentNode;
      ...
      }, Te.enable(!1, !1), C && C.add && !z ? Me.delayedCall(0.01, function () {
        return _ || E || Te.refresh();
      }) && (z = 0.01) && (_ = E = 0) : Te.refresh();
    ...
    if (!i && (Me = e || M(), L() && window.document && (ke = window, _e = document, Pe = _e.documentElement, Ee = _e.body), Me && (Ne = Me.utils.toArray, Ae = Me.utils.clamp, Ve = Me.core.suppressOverwrites || J, Me.core.globals("ScrollTrigger", ScrollTrigger), Ee))) {
      ...
      var t,
        r = Ee.style,
        n = r.borderTop;
      r.borderTop = "1px solid #000", t = at(Ee), it.m = Math.round(t.top + it.sc()) || 0, ot.m = Math.round(t.left + ot.sc()) || 0, n ? r.borderTop = n : r.removeProperty("border-top"), c = setInterval(Ma, 200), Me.delayedCall(0.5, function () {
        return He = 0;
        ...
        return Le = 0;
      }), f = Me.utils.checkPrefix("transform"), H.push(f), i = Xe(), a = Me.delayedCall(0.2, z).pause(), d = [_e, "visibilitychange", function () {
        var e = ke.innerWidth,
          t = ke.innerHeight;
    ...
    var t, r, n, o, i;
    for (r in e) n = _.indexOf(r), o = e[r], "all" === (Fe = r) ? o() : (t = ke.matchMedia(r)) && (t.matches && (i = o()), ~n ? (_[n + 1] = $(_[n + 1], o), _[n + 2] = $(_[n + 2], i)) : (n = _.length, _.push(r, o, i), t.addListener ? t.addListener(Ua) : t.addEventListener("change", Ua)), _[n + 3] = t.matches), Fe = 0;
    return _;
...
!function (t, e) {
  ...
  function am(t) {
    return t < L ? E * t * t : t < 0.7272727272727273 ? E * Math.pow(t - 1.5 / 2.75, 2) + 0.75 : t < 0.9090909090909092 ? E * (t -= 2.25 / 2.75) * t + 0.9375 : E * Math.pow(t - 2.625 / 2.75, 2) + 0.984375;
  }
...
!function (e, n, t) {
  ...
  function o() {
    ...
    for (var a in B) if (B.hasOwnProperty(a)) {
      if (e = [], n = B[a], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length)) for (t = 0; t < n.options.aliases.length; t++) e.push(n.options.aliases[t].toLowerCase());
      for (o = r(n.fn, "function") ? n.fn() : n.fn, A = 0; A < e.length; A++) i = e[A], s = i.split("."), 1 === s.length ? Modernizr[s[0]] = o : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])), Modernizr[s[0]][s[1]] = o), y.push((o ? "" : "no-") + s.join("-"));
    }
  }
  function A(e) {
    var n = Q.className,
  ...
  function g(n, r) {
    ...
    if ("CSSSupportsRule" in e) {
      ...
      return A = A.join(" or "), a("@supports (" + A + ") { #modernizr { position: absolute; } }", function (e) {
  ...
  function h(e, n, o, A) {
    ...
    for (d = e.length, c = 0; d > c; c++) if (p = e[c], m = P.style[p], u(p, "-") && (p = f(p)), P.style[p] !== t) {
  ...
  var y = [],
    ...
    Modernizr = function () {};
  Modernizr.prototype = b, Modernizr = new Modernizr(), Modernizr.addTest("svg", !!n.createElementNS && !!n.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect);
  ...
  var Q = n.documentElement,
    ...
    _ = function () {
      ...
      return n ? function (e) {
        ...
        var t = !1;
        return a("@media " + n + " { #modernizr { position: absolute; } }", function (n) {
  ...
  !function () {
    ...
    x = r(e, "undefined") || r(e.call, "undefined") ? function (e, n) {
  ...
  Modernizr._q.unshift(function () {
    delete P.style;
  }), b.testAllProps = v, b.testAllProps = w, Modernizr.addTest("cssgridlegacy", w("grid-columns", "10px", !0)), Modernizr.addTest("cssgrid", w("grid-template-rows", "none", !0)), Modernizr.addTest("flexbox", w("flexBasis", "1px", !0)), o(), A(y), delete b.addTest, delete b.addAsyncTest;
